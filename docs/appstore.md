...
```
Kroni er den lille familieappen for ukepenger, oppgaver og belønninger som faktisk passer hverdagen. Laget i Norge.
...
PERSONVERN PÅ ALVOR
Ingen sporing for markedsføring, ingen salg av data. GDPR-vennlig og laget i Norge. Familiene som bruker appen betaler for utviklingen.
...
```
Kroni is the small family app for allowance, chores and rewards that actually fits real life. Made in Norway.
...
No marketing tracking, no data sales. GDPR-friendly and made in Norway. The families who use the app pay for it being built.
...
```
Kroni är den lilla familjeappen för veckopeng, sysslor och belöningar som faktiskt passar vardagen. Tillverkad i Norge.
...
Ingen marknadsföringsspårning, ingen försäljning av data. GDPR-vänlig och tillverkad i Norge. Familjerna som använder appen betalar för utvecklingen.
...
```
Kroni er den lille familieapp til lommepenge, opgaver og belønninger, der faktisk passer til hverdagen. Lavet i Norge.
...
Ingen sporing til markedsføring, intet salg af data. GDPR-venlig og lavet i Norge. Familierne der bruger appen betaler for udviklingen.
