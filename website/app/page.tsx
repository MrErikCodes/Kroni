...
const features = [
  {
    title: "Oppgaver",
    description:
      "Opprett oppgaver for barna og følg med på fremgangen. Godkjenn eller avslå med ett trykk, og gi tilbakemelding direkte i appen.",
    icon: "✓",
  },
  {
    title: "Belønninger",
    description:
      "La barna velge belønninger de kan spare opp mot. Motivasjon som faktisk virker — de ser målet og vet hva som trengs.",
    icon: "★",
  },
  {
    title: "Ukepenger 💰",
    description:
      "Sett ukentlig beløp og la Kroni håndtere utbetalingen automatisk. Barna lærer verdien av penger på en trygg og morsom måte.",
    icon: null,
  },
];
    ...
    <>
      ...
      <section className="mx-auto flex max-w-5xl flex-col items-center px-4 py-20 text-center sm:px-6 sm:py-28">
        <h1 className="max-w-2xl text-4xl font-bold leading-tight tracking-tight text-sand-900 sm:text-5xl dark:text-sand-50">
          Ukepenger og oppgaver — enkelt for{" "}
          <span className="text-gold-500">hele familien</span>
        </h1>
        <p className="mt-6 max-w-xl text-lg leading-relaxed text-sand-500 dark:text-sand-200">
          Kroni gir foreldre full oversikt og barna ekte ansvar. Lag oppgaver,
          sett ukepenger og se barna vokse — alt på ett sted.
        </p>
        <div className="mt-10 flex flex-col items-center gap-4 sm:flex-row">
          <a
            ...
            aria-label="Last ned Kroni på App Store"
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            aria-label="Last ned Kroni på Google Play"
        ...
        <p className="mt-4 text-xs text-sand-500 dark:text-sand-500">
          Gratis å laste ned. Abonnement tilgjengelig.
        </p>
      </section>

      {/* Features */}
      <section
        className="bg-sand-100 dark:bg-ink-800"
      ...
      <section className="mx-auto max-w-5xl px-4 py-20 text-center sm:px-6">
        <h2 className="mb-4 text-2xl font-bold text-sand-900 sm:text-3xl dark:text-sand-50">
          Klar til å prøve Kroni?
        </h2>
        <p className="mb-8 text-sand-500 dark:text-sand-200">
          Last ned appen og kom i gang på noen minutter.
        </p>
        <Link
          href="#"
