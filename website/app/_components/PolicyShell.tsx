    ...
    <article className="mx-auto max-w-6xl px-5 pb-24 pt-14 sm:px-8 sm:pb-32 sm:pt-20">
      <header className="border-b border-sand-200 pb-12">
        ...
        {translationNotice ? (
          <aside
            role="note"
            className="mt-8 max-w-2xl rounded-2xl border border-gold-300 bg-gold-100/40 px-5 py-4 text-[13.5px] leading-[1.6] text-sand-700"
          >
            {translationNotice}
          </aside>
        ) : null}
      ...
      <div className="mt-12 grid grid-cols-1 gap-x-12 gap-y-10 lg:grid-cols-12 lg:gap-x-16">
        <aside aria-label={labels.sectionsTitle} className="lg:col-span-3">
