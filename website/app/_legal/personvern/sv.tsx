      ...
      body: (
        <>
          ...
          <ul>
            ...
            <li><strong>Mailpace</strong> (Ohmysmtp Ltd., etablerat i Storbritannien) — levererar våra transaktionella e-postmeddelanden från avsändardomänen <code>kroni.no</code> (autentiserad med SPF, DKIM och DMARC). Behandlar din e-postadress (från Clerk) och själva innehållet i de meddelanden vi skickar dig. Ändamålet är uteslutande att leverera kontonödvändiga tjänste-mejl — registreringsbekräftelse, lösenordsåterställning, e-postverifiering, faktureringsaviseringar (misslyckad betalning, abonnemangets utgång) och inbjudningslänkar till familjehushåll. Rättslig grund är <strong>avtal (GDPR art. 6.1.b)</strong> — vi kan inte drifta kontot utan att leverera dessa meddelanden. Mailpace är underbiträde (sub-processor) under det biträdesavtal vi har med dig och bevarar leveranseloggar enligt sin publicerade lagringsplan; själva e-postinnehållet lagras inte långsiktigt hos oss. Dessa meddelanden är nödvändiga tjänstemeddelanden och kan <strong>inte avregistreras</strong> utan att kontot raderas; eventuella marknadsförings-mejl (vi skickar inga idag) skulle kräva separat samtycke. Vi har valt att skicka egna, lokaliserade mejl i linje med Kronis visuella identitet i stället för Clerks standardmallar, som är inaktiverade.</li>
