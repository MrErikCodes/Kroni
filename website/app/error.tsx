...
// Top-level fallback error boundary. The locale-scoped boundary at
// `app/[lang]/error.tsx` handles errors for the localized routes; this one
// catches anything that escapes that segment. Defaults to English copy.
